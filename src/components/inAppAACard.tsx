    ...
    <>
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          ...
          <CardDescription>Create a smart contract wallet directly within the app.</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="bg-green-100 p-4 rounded-md">
                  ...
                  <ul className="space-y-2 text-sm text-green-800">
                      <li className="flex items-start">
                          ...
                          <span>All the benefits of In-App wallets and account abstraction</span>
                      </li>
                  </ul>
              </div>
          </div>
